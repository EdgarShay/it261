...
// our second if statement - if I have empty fields, is not good, i will echo "please fill out all of the fields!!!
...
// nest another if statement in reference to the field being empty
