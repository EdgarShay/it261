...
<main>
<h1>Absolute, Best Things to do in Puerto Vallarta,Mexico!</h1>

<img src="images/activities.jpg" alt="Activities Image"> 
...
$days = array(
    "Sunday" => "arcos.jpg",
    "Monday" => "parasailing.jpg",
    "Tuesday" => "whale.jpg",
    "Wednesday" => "botanical.jpg",
    "Thursday" => "skydiving.jpg",
    "Friday" => "zona-romantica.jpg",
    "Saturday" => "dolphins.jpg"
);
?> 
...
<h2>Don't see your favorite activity? Check out 
the days below!</h2>
...
<aside>
<h3>What's Next Activity On Your List</h3>
