...
echo 'We might be going to the beach!';
   ...
   echo 'We will <b>definetily</b> go to the beach!';
}

echo '<h2>This exercise will be about a salary, a bonus and sales!</h2>';
// a salary of 95000 - annual
// sales need to be above 100000, you willl start making bonus!!!
// 100000 = 5%
// 120000 = 10%
// 140000 = 15%
// 150000 = 20%
...
// if sales is equal or less than 1199999, then you will receive 5 %
// if sales is equal or less than 1399999, then you will receive 10 %
// if sales is equal or less than 1499999, you will receive 15 %
if($sales <=99999) {
